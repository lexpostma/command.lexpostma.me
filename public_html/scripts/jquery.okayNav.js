...
(function(factory) {
    ...
    var okayNav = 'okayNav',
        defaults = {
            ...
            toggle_icon_content: '<span class="hamburger-box"><span class="hamburger-inner"></span></span>',
            align_right: true, // If false, the menu and the kebab icon will be on the left
            swipe_enabled: false, // If true, you'll be able to swipe left/right to open the navigation
            threshold: 50, // Nav will auto open/close if swiped >= this many percent
            resize_delay: 20, // When resizing the window, okayNav can throttle its recalculations if enabled. Setting this to 50-250 will improve performance but make okayNav less accurate.
        ...
        init: function() {
            ...
            if (self.options.align_right) {
                self.navigation
                    ...
                    .append('<button class="hamburger hamburger--spin ' + self.options.toggle_icon_class + ' okay-invisible" type="button">' + self.options.toggle_icon_content + '</button>')
            } else {
                self.navigation
                    .prepend('<ul class="okayNav__nav--invisible transition-enabled nav-left" />')
                    .prepend('<button class="hamburger hamburger--spin ' + self.options.toggle_icon_class + ' okay-invisible" type="button">' + self.options.toggle_icon_content + '</button>')
            }
